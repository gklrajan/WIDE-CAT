...
%% Parameters
mat_path = 'D:\Gokul\2024-Widefield\data\motion_corrected_rigid\03_preprocessed_dc5_test_motion_corrected\preprocessed_dc5_test_motion_corrected.mat';
...
hex_rois = segment_hexagonal_rois(mat_path, brain_mask, 5); % After binning: 5-pixel radius - 6.5um rad/ 13um dia x-y and 5um z
...
create_dff_max_projection(dff_signals, hex_rois,1:200);
...
plot_dff_raster_with_stim(dff_signals, stim_periods_per_slice, 1:40,1:200);
%1:size(dff_signals, 2)
...
% Load your workspace with: dff_signals, stim_periods_per_slice, tone_sequence, hex_rois
analyze_frequency_responses_regression(dff_signals, stim_periods_per_slice, tone_sequence, hex_rois, brain_mask, frames_per_volume, stim_start_volume);
