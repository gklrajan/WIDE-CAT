...
if download_demo_file:
    ...
    datasets_path = 'D:\\Gokul\\2024-Widefield\data\\motion_corrected_rigid\\train_adult\\separated_zplanes\\this'  # folder containing tif files for training
...
pth_dir = os.path.join(datasets_path, "vis")   # pth file and visualization result file path
num_workers = 4             # if you use Windows system, set this to 0. was 4
