...
%% — USER PARAMETERS —
INPUT_ROOT     = 'F:\WilDeCaT\Data\004_huc-sound_';       % root folder with subfolders of TIFFs
...
slices_per_vol = 40;      % number of z-slices per volume
clip_percentile = 98;     % percentile for per-frame clipping
max_shift       = 3;      % max allowed shift (pixels)
